...
public class AssetSetter {
    ...
    public void setObject() {
        ...
        for (int i = 3; i < 20; i++) {
            ...
            do {
                ...
                wx.add(gp.obj[i].worldX);
                wy.add(gp.obj[i].worldY);

                for (int j = 0; j < i; j++) {
                    if (checkCollision(gp.obj[i], gp.obj[j])) {
                        isCollision = true;
                        wx.remove(wx.size() - 1);
                        wy.remove(wy.size() - 1);
                        break;
    ...
    public boolean checkCollision(SuperObject obj1, SuperObject obj2) {
        int obj1Left = obj1.worldX;
        int obj1Right = obj1.worldX + gp.tileSize;
        int obj1Top = obj1.worldY;
        int obj1Bottom = obj1.worldY + gp.tileSize;

        int obj2Left = obj2.worldX;
        int obj2Right = obj2.worldX + gp.tileSize;
        int obj2Top = obj2.worldY;
